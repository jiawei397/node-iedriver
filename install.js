...
var downloadUrl = helper.downloadUrl + '%s/IEDriverServer_Win32_%s.zip'
var downloadUrl64 = helper.downloadUrl + '%s/IEDriverServer_x64_%s.zip'
...
function getRequestOptions(_downloadUrl) {
    const options = {uri: _downloadUrl, method: 'GET', timeout: 0};
